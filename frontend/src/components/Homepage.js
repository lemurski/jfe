...
import { SiDjango, SiReact, SiJavascript, SiDocker, SiPython, SiTailwindcss, SiFacebook, SiInstagram } from 'react-icons/si'
...
export default function Homepage() {
    ...
    return (
        <div id='home' className="dark:bg-dark-gray flex flex-col w-full h-auto px-[5%] lg:px-[15%] transition-all duration-500 bg-light-yellow">
                    ...
                    <div className="grid xl:grid-cols-2 grid-cols-1 text-white gap-4 mx-auto w-full h-auto xl:h-[36rem]">
                        <div className="xl:w-[41rem] flex flex-col w-auto" >
                            ...
                            <div className="flex animate-animated animate-fadeInDown animate-delay-2s mx-auto xl:mx-0 mt-5">
                                ...
                                <div className='hover:scale-105 hover:-translate-y-1 duration-200 flex items-center ease-in transition-all'><a href='#my_work' className="w-32 ml-4 font-semibold tracking-wider text-center py-[0.812rem] border-[3px] text-dark-gray dark:text-gray-200 border-dark-gray dark:border-gray-200 rounded-xl ">My Work</a></div>
                            </div>
                        </div>
            ...
            <div id='contact' className="w-full flex h-auto mt-20 px-6 lg:px-[15%] flex-col">
                    ...
                    <div className="flex justify-start sm:justify-end">
                        <div className="w-[220px]">
                            <ul className="text-base sm:text-lg text-dark-gray dark:text-gray-200">
                                ...
                                <li className="skills"><BiNetworkChart className="icon" /><span className="font-bold">Machine Learning</span></li>
            ...
            <div className="w-full flex my-20 px-6 lg:px-[15%] flex-col">
